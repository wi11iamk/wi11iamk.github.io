document.addEventListener('DOMContentLoaded', function() {
  ...
  var textReplies = function() {
    switch(textInputValueLowerCase){
      case "about":
        clearInput();
        addTextToResults("Hello 👋<br>My name is William Kistler. I am a Neuroscientist trained at the National Institutes of Health and UCL Queen Square Institute of Neurology. I have passions for the movement and visual neurosciences, as well as applications and safeguards for ML in healthcare and the life sciences. Currently, I am a T32 Research Fellow in Rehabilitation for Brain Injury and Neurological Disability with Kennedy Krieger Institute and Johns Hopkins University School of Medicine. Outside of research, I can be found writing or watching any number of <a target = _blank href='https://mubi.com/lists/love' >films that I love</a>!");
        break;
      ...
      case "skills":
        clearInput();
        addTextToResults("Languages: Python, C, Git, Bash, Cython<br>Technologies: Virtual reality, Motion capture, Pose estimation, Computer vision, MEG<br>Software/Libraries: PyTorch, NumPy, pandas, scikit-learn, DeepLabCut, PsyToolkit, MTurk, Inkscape, Blender, GNU/Linux");
        break;
